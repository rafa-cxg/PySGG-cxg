...
from pysgg.modeling.roi_heads.relation_head.utils_motifs import obj_edge_vectors,\
    to_onehot, encode_box_info
...
class SHA_Context(nn.Module):
    def __init__(self, config, obj_classes, rel_classes, in_channels):
        ...
        self.lin_edge_visual = nn.Linear(self.hidden_dim + self.in_channels+self.language_obj_dim, self.hidden_dim)
