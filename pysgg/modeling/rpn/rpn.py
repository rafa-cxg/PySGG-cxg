...
class RPNModule(torch.nn.Module):
    ...
    def forward(self, images, features, targets=None):
        ...
        """
        objectness, rpn_box_regression = self.head(features)#objectness:list-5,对应5个backbone layer的feature
        anchors = self.anchor_generator(images, features)#boxlist-num_image
    ...
    def _forward_train(self, anchors, objectness, rpn_box_regression, targets):
        if self.cfg.MODEL.RPN_ONLY:#end-to-end训练还需要训练rcnn部分
            ...
            with torch.no_grad():
                ...
                )#boxs已经限制在1000个/Images，训练模式下，anchor添加gt box
