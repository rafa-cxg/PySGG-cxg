...
class AnchorGenerator(nn.Module):
    ...
    def forward(self, image_list, feature_maps):
        grid_sizes = [feature_map.shape[-2:] for feature_map in feature_maps]#list:5 几层feature map的h、w
        anchors_over_all_feature_maps = self.grid_anchors(grid_sizes)#list:5 [num_anchors,4]
        anchors = []
        ...
        return anchors#和anchors_over_all_feature_maps相比，tensor变为boxlist,添加visbility
